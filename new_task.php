			...
			<div class="row">
				<div class="col-md-3 menu">
					<ul class="list-group">
						...
						<li class="list-group-item active"><a href="new_task.php">Nova tarefa</a></li>
							...
							<div class="col">
								...
								<form method="POST" action="task_controller.php?action=insert">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="item_task" placeholder="Exemplo: Lavar o carro">
									</div>
